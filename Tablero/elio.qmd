...
ui <- fluidPage(
  tags$img(src = "imagenes/background.jpeg", style = "position: absolute"),
...
#  })
  ...
  output$fotito = renderImage({
    ...
    filename = sprintf("imagenes/foto_%s.jpeg", gsub(" |\n", "_", tolower(fileimg)))
    list(src = ifelse(length(filename) == 0, "imagenes/inecol.jpg", filename ),
  ...
  output$loguito = renderImage({
    ...
    list(src = ifelse(length(filelogo) == 0, "imagenes/logo_inecol.png", filename ),
