...
La aplicación para operar rutinaria y automáticamente con *Google Drive* para registrar en una base de datos *SQLite* los productos contenidos de los PPronaii ya está lista.
